class FSW_PARAMS:
    def __init__(self):
        ...
        self.FB_PULSE1_V = 2.90         # fallback voltage for 65% SOC
        self.FB_PULSE2_V = 2.80         # fallback voltage for 30% SOC
        self.SOC_PULSE1 = 0.65          # SOC to perform pulse 1
        self.SOC_PULSE2 = 0.30          # SOC to perform pulse 2
        self.TIME_CYCLE_REST_S = 120    # time to rest between charge/discharge cycles, seconds  [NOMINALLY  5 MINUTES]
        ...
        self.TIME_TEST_REST_S = 1800    # time to rest before and after char test, seconds       [NOMINALLY  1 HOUR]
        ...
        self.CHG_LOW_SETPT_MA = -4.5    # setpoint for 1/10 C charging
